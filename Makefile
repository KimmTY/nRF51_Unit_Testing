...
$(abspath components/Unity-master/src/unity.c) \
$(abspath components/Unity-master/extras/fixture/src/unity_fixture.c) \
$(abspath ./src/ProductionCode.c) \
$(abspath ./test/TestProductionCode.c) \
$(abspath ./test/test_runners/TestProductionCode_Runner.c) \
...
INC_PATHS += -I$(abspath components/Unity-master/src)
INC_PATHS += -I$(abspath components/Unity-master/extras/fixture/src)
